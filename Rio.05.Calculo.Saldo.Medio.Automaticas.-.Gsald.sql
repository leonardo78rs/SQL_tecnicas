...
------ Pegar Saldo Anterior 
            ...
            Select COUNT(0) INTO VS_recno from AG4501.CCRGSMES SM WHERE  SM.FCTAAPLI = AJUS.FCTAAPLI AND IS_DELETED = 'N' and sm.fcanomes = '201407' ;
            
            If vs_Recno > 0 then 
               Select sm.recno  INTO VS_Recno from AG4501.CCRGSMES SM WHERE SM.FCTAAPLI = AJUS.FCTAAPLI AND IS_DELETED = 'N' and sm.fcanomes = '201407' ;
            END IF ; 
            ...
            If (vs_mediotemp <> 0 AND VS_RECNO <> 0 ) then 
               ...
               update ag4501.ccrgsmes set fnsldmedio = vs_mediotemp where recno = vs_recno ;
            ...
            ------  Select sum(fnsldmedio) from ag4501.ccrgsmes where fcanomes = '201407' ; --- isto dava zero antes de rodar 
